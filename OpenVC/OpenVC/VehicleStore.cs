...
namespace OpenUtils
{
    class VehicleStore
    {
        ...
        {
            bool result = false;
            foreach(Vehicle v in tbovehicles)
            {
        ...
        {
            bool result = false;
            foreach (Vehicle v in managedVehicles)
            {
                if (veh == v) result = true;
            }
            return result;
        ...
        {
            bool result = false;
            foreach (Vehicle v in calledVehicles)
            {
                if (veh == v) result = true;
            }
            return result;
        ...
        {
            bool result = false;
            foreach (Vehicle v in wasCalled)
            {
                if (veh == v) result = true;
            }
            return result;
        ...
        {
            bool result = false;
            foreach (Vehicle v in hornyVehicles)
            {
                if (veh == v) result = true;
            }
            return result;
